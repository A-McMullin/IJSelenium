...
public class StaticWebTableDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.get(url);
        List<WebElement> webData = driver.findElements(By.xpath("//table[@id='task-table']/tbody/tr"));
        System.out.println(webData.size());

        Iterator<WebElement> it= webData.iterator();
        while(it.hasNext()) {
